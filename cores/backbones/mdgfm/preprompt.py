...
from cores.backbones.mdgfm.models import Lp, GcnLayers
from cores.backbones.mdgfm.layers import AvgReadout
import numpy as np
from cores.backbones.mdgfm.utils import Calbound
from sklearn.decomposition import PCA
from cores.backbones.mdgfm.layers import Attentivemod
from cores.backbones.mdgfm.tools import *
...
class PrePrompt(nn.Module):
    ...
    def forward(self, seq1, seq2, seq3, seq4, seq5, adj1, adj2, adj3, adj4, adj5, sparse, msk, samp_bias1, samp_bias2, i):
    ...
    def embedding(self, seq1, seq2, seq3, seq4, seq5, adj1, adj2, adj3, adj4, adj5, sparse, msk, samp_bias1, samp_bias2):
        seq1 = torch.squeeze(seq1, 0)
        seq2 = torch.squeeze(seq2, 0)
        seq3 = torch.squeeze(seq3, 0)
        seq4 = torch.squeeze(seq4, 0)
