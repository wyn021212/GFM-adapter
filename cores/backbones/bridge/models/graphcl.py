...
from cores.backbones.bridge.layers import AvgReadout, Discriminator
...
class GraphCL(nn.Module):
    ...
    def forward(self, gcn, seq1, seq2, seq3, seq4, adj, aug_adj1, aug_adj2, sparse, msk, samp_bias1, samp_bias2, aug_type):
